...
//		wardList.add(station3);
		...
		// Fï¿½ge eine Beispielcheckliste ein
	...
	public void storePatients(Context context) {
		...
		//Log.w("lel", "Lï¿½nge der wardlist: "+wardList.size());	// TODO: Log entfernen
		for (Ward w: wardList) {
			//Log.w("lel", "Lï¿½nge der patientenListe: "+w.getPatientList().size()); // TODO: Log entfernen	
	...
	public void storeAllAntibioticTitles(Context context) {
		...
		for(String at : allAntibiotics) {
			Log.w("lel", "Fï¿½ge Antibiotikum hinzu: "+at);
	...
	public ArrayList<String> getAllDosages() {
		...
		String[] dosages = {"40mg", "50mg", "80mg", "100mg", "150mg", "160mg", "200mg", "240mg", "250mg",
				"300mg", "375mg", "400mg", "480mg", "500mg", "600mg", "750mg", "960mg", "0,5g", "1,0g",
				"1,5g", "2,0g", "3,0g", "4,0g", "4,5g", "5,0g", "1,0 Mio IE", "1,2 Mio IE", "2,0 Mio IE",
				"5,0 Mio IE", "10,0 Mio IE", "körpergewichtsadaptiert", "nach Ansage"};
		ArrayList<String> allDosages = new ArrayList<String>();
		
		for (int i=0; i<dosages.length; i++) {
			allDosages.add(dosages[i]);
		}
