...
public class MySQLiteHelper extends SQLiteOpenHelper {
	...
	public void insertSampleData(SQLiteDatabase database) {
		...
		wardValues.put(WARD_NAME, "Station");
		...
		patientValues.put(PATIENT_DESCRIPTION, "Patient M");
		patientValues.put(PATIENT_BIRTHDAY, 19991223);
		...
		patientValues.put(PATIENT_DESCRIPTION, "Patient F");
		...
		checklistValues.put(CHECKLIST_OWNER, "Patient M");
		...
		antibioticValues.put(ANTIBIOTIC_OWNER, "Patient M");
